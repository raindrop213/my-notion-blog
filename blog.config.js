...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi！这有我觉得好玩的项目💻,Hi！这有我学习的笔记📚,Hi！这还有些乱七八糟的东西😂,☕工作的目的便是获得空闲 ——亚里士多德,我成天琢磨的，都是如何不用工作，也能维持自由玩乐的生活🀅 ——松浦弥太郎,我最大的能耐就是躺着不动🛌 ——卡夫卡,hhh 欢迎来到我的博客🎉',
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/raindrop213', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/song/media/outer/url?id=420693.mp3',
      cover:
            'http://p1.music.126.net/7yYBs2fUALPkxRj0UJvJaA==/720180116205373.jpg'
    },
    {
      name: '海の形',
      artist: 'Falcom Sound Team jdk',
      url: 'https://music.163.com/song/media/outer/url?id=535056564.mp3',
      cover:
            'http://p1.music.126.net/tBHOY6ZMq6grfs3GcvJWbg==/109951163768131371.jpg'
    }
  ],
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9140436152', // 对应歌单的 id
