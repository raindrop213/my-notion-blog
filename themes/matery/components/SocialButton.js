...
const SocialButton = () => {
  ...
  return (
    <div className='flex flex-col items-center w-10 transform hover:scale-105 duration-200 text-white text-center bg-lime-900 rounded-full dark:bg-black cursor-pointer overflow-hidden select-none'>
      {!show && (
        <i
          onClick={toggleShow}
